...
5. [ ] Use aiolimiter library to handle rate limits, research the API to see if and when you need to apply such measures. <https://github.com/mjpieters/aiolimiter>, it can be combined with stamina (<https://github.com/hynek/stamina>), handle with care.
